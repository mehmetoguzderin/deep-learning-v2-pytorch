...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # Reuses the result of sigmoid function to speed up calculations
        self.activation_function_prime_cached = lambda x : x * (1 - x)
    ...
    def run(self, features):
        ...
        hidden_outputs = np.activation_function(hidden_inputs) # signals from hidden layer
        
        # TODO: Output layer - Replace these values with the appropriate calculations.
        final_inputs = np.dot(hidden_outputs, self.weights_hidden_to_output) # signals into final output layer
        final_outputs = np.activation_function(final_inputs) # signals from final output layer 
